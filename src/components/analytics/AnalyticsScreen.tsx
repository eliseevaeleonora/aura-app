...
export default function AnalyticsScreen() {
  const [const wellness = useAuraStore((s) => s.wellness)
  ...
  return (
    <div className="h-full overflow-y-auto scroll-hide">
      ...
      >
        ...
        {/* AI Insig<motion.div variants={stagger.item} className="px-5 pb-4">
  ...
  <Card className="p-4">
    <div className="flex gap-2 mb-3 justify-between">
      {[
        ...
        <button key={mood}
          onClick={() => setWellness({ mood: mood as any })}
    ...
    <textarea
      ...
      placeholder="Как прошёл твой день? Что чувствуешь?..."
      rows={3}
